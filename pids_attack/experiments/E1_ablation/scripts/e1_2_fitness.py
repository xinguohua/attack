"""E1.2 Fitness design — §5.3 two-objective ablation.

Variants(对应 `p3_results.md` §3.9):
  f1_only / f1_f2(default)

cfg.objective + 子层选 dispatch。所有变量都通过同一 attack.safemimic_cmd 框架运行。
"""
...
VARIANTS: Dict[str, Dict[str, Any]] = {
    "f1_only": {"objective": "f1_only"},
    "f1_f2":   {"objective": "f1_f2"},
}
...
def main(argv: Optional[Sequence[str]] = None) -> Dict[str, Any]:
    p = argparse.ArgumentParser(description="E1.2 fitness design ablation")
    ...
    summary["experiment"] = "E1.2_fitness"
    write_summary(summary, args.output)
    print(f"[E1.2/{args.variant}] converged={summary['converged']} q={summary['q_used']} |Δ|={summary['delta_len']} wall={wall:.1f}s")
    return summary
