...
warm_start_from_benign:从 detection/data/training_traces/benign_*.sql 重建 CommandGraph 填 R_unflagged。
  本步骤依赖 detection/training/rules.py::sql_to_cmd_graph;缺失时 warm_start
  为 no-op stub(R 起步空,前几 stage f_2 约为 0.5 中性)。
"""
...
class Reference:
    ...
    def warm_start_from_benign(
        ...
        Returns:
            Reference 实例
        """
        from attack.safemimic_cmd.surrogate import wl_feature_vector
